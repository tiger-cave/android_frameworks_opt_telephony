...
public class RIL extends BaseCommands implements CommandsInterface {
     ...
     * HAL_SERVICE_RADIO is the HIDL IRadio service, and
     * mDisabledRadioServices.get(HAL_SERVICE_RADIO) will return a set of all phone ID slots that
     * are disabled for IRadio.
     */
    ...
    public void invokeOemRilRequestRaw(byte[] data, Message response) {
        ...
        if (oemHookProxy != null) {
            ...
            try {
                ...
                handleRadioProxyExceptionForRR(HAL_SERVICE_RADIO, "invokeOemRilRequestRaw", e);
            }
        } else {
    ...
    public void invokeOemRilRequestStrings(String[] strings, Message result) {
        ...
        if (oemHookProxy != null) {
            ...
            try {
                ...
                handleRadioProxyExceptionForRR(HAL_SERVICE_RADIO, "invokeOemRilRequestStrings", e);
            }
        } else {
            // OEM Hook service is disabled for P and later devices.
            // Deprecated OEM Hook APIs will perform no-op before being removed.
    ...
    public void setAllowedCarriers(CarrierRestrictionRules carrierRestrictionRules,
        ...
        radioServiceInvokeHelper(HAL_SERVICE_SIM, rr, "setAllowedCarriers", () -> {
            simProxy.setAllowedCarriers(rr.mSerial, carrierRestrictionRules,
                    getHalVersion(HAL_SERVICE_SIM), result);
        });
    }
